# ⚓ VOYAGE 1492 — Your LLM is the Captain
...
- 🏆 **Your model is your handicap** — Hall of Fame records which brain earned the score
- 🤖 **Full Auto mode** — let the brain run the whole company and just watch. *No LLM has beaten this game yet.*

No server, no account, no tracking. Everything runs in your browser.
